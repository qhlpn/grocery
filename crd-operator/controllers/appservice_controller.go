...
//+kubebuilder:rbac:groups=learning.demo,resources=appservices,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=learning.demo,resources=appservices/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=learning.demo,resources=appservices/finalizers,verbs=update
