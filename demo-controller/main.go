...
import (
	...
	informers "demo-controller/pkg/generated/informers/externalversions"
	"demo-controller/signals"
	"flag"
	"time"
...
func main() {
	...
	controller := NewController(kubeClient, demoClient, demoInformerFactory.Demo().V1().Demos())
