...
import (
	"context"
	democomv1 "demo-controller/pkg/apis/demo.com/v1"
	versioned "demo-controller/pkg/generated/clientset/versioned"
	internalinterfaces "demo-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "demo-controller/pkg/generated/listers/demo.com/v1"
	time "time"
...
func (f *demoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&democomv1.Demo{}, f.defaultInformer)
}
